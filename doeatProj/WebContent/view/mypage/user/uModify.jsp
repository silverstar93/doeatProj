...
<h3 class="temptitle">회원 정보 수정</h3>
	<table width="100%" cellspacing="5">
		...
		<tr>
			<td>비밀번호</td>
			<td><input type="button" name="pw" value="비밀번호 변경하기"
				onclick="pwch()" /></td>
		</tr>
		<tr>
			<td colspan="2"></td>
		...
		<tr>
			...
			<td><select name="tel1" id="tel1">
				...
				value="${parr[1] }" /> - <input name="tel3" id="tel3" type="text"
				maxlength="4" size="5" value="${parr[2] }" /></td>
		</tr>
		<tr>
			<td>이메일</td>
			<td>${earr[0] }@ ${earr[1] }</td>
		...
		<tr>
			<td colspan="2" align="right"><input type="button" onclick="mod()" value="수정" />
				<a href="uModify"><input type="button" value="초기화" /></a> <a
				href="index">돌아가기</a></td>
		</tr>
	</table>
</form>